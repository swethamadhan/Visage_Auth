...
# class training:
#     def __init__(self, datadir, modeldir, embeddings_filename):
#         self.datadir = datadir
#         self.modeldir = modeldir
...
#                 embeddings_file_name = os.path.expanduser(self.embeddings_filename)
#                 class_names = [cls.name.replace('_', ' ') for cls in img_data]

#                 # Saving embeddings and class names
#                 with open(embeddings_file_name, 'wb') as outfile:
